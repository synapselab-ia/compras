...
**PROJECT_STATUS:** F29_IMPLEMENTED_PR_GREEN_F30_READY  
**CURRENT_PHASE:** F29 implementada e verificada na PR #45; F30 READY; F21 ON HOLD; F17 ON HOLD histórico  
**REPO_VISIBILITY:** PUBLIC  
**APPLICATION_STATUS:** HOSTED_DEMO_AVAILABLE_SELF_HOSTED_AUTH_SIGNIN_LIMITER_NEXT_ACTION_WRITE_UI_AND_CONTRACTING_CREATE_BOUNDARY_IMPLEMENTED  
...
**F29_PR:** `#45` — OPEN / GREEN PRE-MERGE CHECKPOINT  
**F29_FUNCTIONAL_HEAD:** `d35edbd54e516de9c2eac943d3c854a30ed729a9`  
**F29_GREEN_CHECKPOINT_HEAD:** `889e278f9501096516d1a5a577bf21e840fd7ffd`  
**F29_PR_CI_RUN:** `34637397308` — PASS  
**F29_PR_F22_PREFLIGHT_RUN:** `34637397405` — PASS  
**F29_PR_CREATE_RUN:** `34637397361` — PASS  
**LAST_GOOD_COMMIT:** `889e278f9501096516d1a5a577bf21e840fd7ffd`  
**LAST_GOOD_CI_RUN:** `34637397308`  
...
## F29 — criação persistente mínima implementada
...
Head funcional corrigido `d35edbd54e516de9c2eac943d3c854a30ed729a9` ficou verde. O checkpoint documental `889e278f9501096516d1a5a577bf21e840fd7ffd` repetiu todos os gates com sucesso:
...
## Promoção pendente deste checkpoint

Antes de encerrar definitivamente F29, o head documental final desta PR deve repetir CI + F22 + F29 em verde, a PR `#45` deve ser mergeada e os gates pós-merge em `main` devem ser confirmados. O checkpoint final em `main` registrará o merge e manterá F30 como única `NEXT_ACTION`.
