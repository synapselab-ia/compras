...
**PR:** `#65`  
**Head final verificado:** `24fccfbd9a58a7ddfd265b7f6b3ec05646e583e0`  
...
Head final `24fccfbd9a58a7ddfd265b7f6b3ec05646e583e0`:
...
O conector GitHub disponível expõe runs associados ao evento de pull request, mas não fornece readback dos runs de push do merge commit. Portanto nenhum PASS pós-merge é afirmado sem evidência. O conteúdo executável promovido corresponde ao head final verificado e `main` não avançou entre a base da PR e o merge.
